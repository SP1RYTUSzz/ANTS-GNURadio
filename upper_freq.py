...
class upper_freq(gr.top_block):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_vector_to_stream_0_0, 0), (self.blocks_threshold_ff_0_0, 0))
        self.connect((self.blocks_vector_to_stream_0_0, 0), (self.blocks_threshold_ff_0_0_0, 0))
    ...
    def get_threshold2_dB(self):
        return self.threshold2_dB
