...
class file_source_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_number_sink_0.set_title("Power Spectral Density")
        ...
        self.blocks_multiply_const_xx_1_0 = blocks.multiply_const_ff(1/dec * vec_len, vec_len)
        ...
        self.blocks_integrate_xx_0_0 = blocks.integrate_ff(1000, vec_len)
    ...
    def set_vec_len(self, vec_len):
        ...
        self.blocks_multiply_const_xx_1_0.set_k(1/self.dec * self.vec_len)
